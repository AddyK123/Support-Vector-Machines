...
```{r results=FALSE}
train <- read.csv("/Users/adityakhera/Desktop/AML Practice/Pset 3/LASSO_train.csv")
test <- read.csv("/Users/adityakhera/Desktop/AML Practice/Pset 3/LASSO_test.csv")
library(caret)
```
