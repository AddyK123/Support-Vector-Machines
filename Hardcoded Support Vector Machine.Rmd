...
```{r}
set.seed(2)
data5 <- read.csv("/Users/adityakhera/Desktop/AML Practice/Pset 3/train.5.txt", header=FALSE,)
data6 <- read.csv("/Users/adityakhera/Desktop/AML Practice/Pset 3/train.6.txt", header=FALSE,)
